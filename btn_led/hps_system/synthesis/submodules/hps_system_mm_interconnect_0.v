...
module hps_system_mm_interconnect_0 (
	...
	wire  [113:0] keys_s1_agent_rp_data;                                    // keys_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [113:0] sw_s1_agent_rp_data;                                      // sw_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [113:0] cmd_mux_src_data;                                         // cmd_mux:src_data -> keys_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                        // keys_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [2:0] cmd_mux_src_channel;                                      // cmd_mux:src_channel -> keys_s1_burst_adapter:sink0_channel
	...
	wire    [2:0] keys_s1_burst_adapter_source0_channel;                    // keys_s1_burst_adapter:source0_channel -> keys_s1_agent:cp_channel
	...
	wire  [113:0] cmd_mux_002_src_data;                                     // cmd_mux_002:src_data -> sw_s1_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                    // sw_s1_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [2:0] cmd_mux_002_src_channel;                                  // cmd_mux_002:src_channel -> sw_s1_burst_adapter:sink0_channel
	...
	altera_merlin_axi_master_ni #(
		...
		.aresetn                (~keys_reset_reset_bridge_in_reset_reset),                  //        clk_reset.reset_n
