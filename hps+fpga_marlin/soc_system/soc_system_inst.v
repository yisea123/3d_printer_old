	soc_system u0 (
		...
		.step_motor_e0_connection_export          (<connected-to-step_motor_e0_connection_export>),          //          step_motor_e0_connection.export
		.step_motor_e1_external_connection_export (<connected-to-step_motor_e1_external_connection_export>), // step_motor_e1_external_connection.export
		.step_motor_x_external_connection_export  (<connected-to-step_motor_x_external_connection_export>),  //  step_motor_x_external_connection.export
		.step_motor_y_external_connection_export  (<connected-to-step_motor_y_external_connection_export>),  //  step_motor_y_external_connection.export
		.step_motor_z_external_connection_export  (<connected-to-step_motor_z_external_connection_export>),  //  step_motor_z_external_connection.export
		...
		.x_max_pin_external_connection_export     (<connected-to-x_max_pin_external_connection_export>),     //     x_max_pin_external_connection.export
		.x_min_pin_external_connection_export     (<connected-to-x_min_pin_external_connection_export>),     //     x_min_pin_external_connection.export
		.y_max_pin_external_connection_export     (<connected-to-y_max_pin_external_connection_export>),     //     y_max_pin_external_connection.export
		.y_min_pin_external_connection_export     (<connected-to-y_min_pin_external_connection_export>),     //     y_min_pin_external_connection.export
		.z_max_pin_external_connection_export     (<connected-to-z_max_pin_external_connection_export>),     //     z_max_pin_external_connection.export
		.z_min_pin_external_connection_export     (<connected-to-z_min_pin_external_connection_export>)      //     z_min_pin_external_connection.export
	);
