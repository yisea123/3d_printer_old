...
module soc_system_mm_interconnect_1 (
	...
	wire  [84:0] cmd_mux_src_data;                                                  // cmd_mux:src_data -> led_s1_agent:cp_data
	...
	wire  [14:0] btn_s1_agent_m0_address;                                           // btn_s1_agent:m0_address -> btn_s1_translator:uav_address
	...
	wire  [85:0] btn_s1_agent_rf_source_data;                                       // btn_s1_agent:rf_source_data -> btn_s1_agent_rsp_fifo:in_data
	...
	wire  [85:0] btn_s1_agent_rsp_fifo_out_data;                                    // btn_s1_agent_rsp_fifo:out_data -> btn_s1_agent:rf_sink_data
	...
	wire         cmd_mux_001_src_valid;                                             // cmd_mux_001:src_valid -> btn_s1_agent:cp_valid
	wire  [84:0] cmd_mux_001_src_data;                                              // cmd_mux_001:src_data -> btn_s1_agent:cp_data
	wire         cmd_mux_001_src_ready;                                             // btn_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [1:0] cmd_mux_001_src_channel;                                           // cmd_mux_001:src_channel -> btn_s1_agent:cp_channel
	wire         cmd_mux_001_src_startofpacket;                                     // cmd_mux_001:src_startofpacket -> btn_s1_agent:cp_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                       // cmd_mux_001:src_endofpacket -> btn_s1_agent:cp_endofpacket
	...
	wire  [84:0] led_s1_agent_rp_data;                                              // led_s1_agent:rp_data -> router_001:sink_data
	...
	wire         btn_s1_agent_rp_valid;                                             // btn_s1_agent:rp_valid -> router_002:sink_valid
	wire  [84:0] btn_s1_agent_rp_data;                                              // btn_s1_agent:rp_data -> router_002:sink_data
	wire         btn_s1_agent_rp_ready;                                             // router_002:sink_ready -> btn_s1_agent:rp_ready
	wire         btn_s1_agent_rp_startofpacket;                                     // btn_s1_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire         btn_s1_agent_rp_endofpacket;                                       // btn_s1_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire         btn_s1_agent_rdata_fifo_src_valid;                                 // btn_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] btn_s1_agent_rdata_fifo_src_data;                                  // btn_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         btn_s1_agent_rdata_fifo_src_ready;                                 // avalon_st_adapter_001:in_0_ready -> btn_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                 // avalon_st_adapter_001:out_0_valid -> btn_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                  // avalon_st_adapter_001:out_0_data -> btn_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                 // btn_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                 // avalon_st_adapter_001:out_0_error -> btn_s1_agent:rdata_fifo_sink_error
