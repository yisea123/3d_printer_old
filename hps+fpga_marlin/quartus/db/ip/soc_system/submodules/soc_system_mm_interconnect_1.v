...
module soc_system_mm_interconnect_1 (
	...
	wire          cmd_mux_012_src_valid;                                                      // cmd_mux_012:src_valid -> y_min_pin_s1_agent:cp_valid
	wire  [109:0] cmd_mux_012_src_data;                                                       // cmd_mux_012:src_data -> y_min_pin_s1_agent:cp_data
	wire          cmd_mux_012_src_ready;                                                      // y_min_pin_s1_agent:cp_ready -> cmd_mux_012:src_ready
	wire   [19:0] cmd_mux_012_src_channel;                                                    // cmd_mux_012:src_channel -> y_min_pin_s1_agent:cp_channel
	wire          cmd_mux_012_src_startofpacket;                                              // cmd_mux_012:src_startofpacket -> y_min_pin_s1_agent:cp_startofpacket
	wire          cmd_mux_012_src_endofpacket;                                                // cmd_mux_012:src_endofpacket -> y_min_pin_s1_agent:cp_endofpacket
	...
	wire          cmd_mux_013_src_valid;                                                      // cmd_mux_013:src_valid -> y_max_pin_s1_agent:cp_valid
	wire  [109:0] cmd_mux_013_src_data;                                                       // cmd_mux_013:src_data -> y_max_pin_s1_agent:cp_data
	wire          cmd_mux_013_src_ready;                                                      // y_max_pin_s1_agent:cp_ready -> cmd_mux_013:src_ready
	wire   [19:0] cmd_mux_013_src_channel;                                                    // cmd_mux_013:src_channel -> y_max_pin_s1_agent:cp_channel
	wire          cmd_mux_013_src_startofpacket;                                              // cmd_mux_013:src_startofpacket -> y_max_pin_s1_agent:cp_startofpacket
	wire          cmd_mux_013_src_endofpacket;                                                // cmd_mux_013:src_endofpacket -> y_max_pin_s1_agent:cp_endofpacket
	...
	wire          y_min_pin_s1_agent_rp_valid;                                                // y_min_pin_s1_agent:rp_valid -> router_014:sink_valid
	wire  [109:0] y_min_pin_s1_agent_rp_data;                                                 // y_min_pin_s1_agent:rp_data -> router_014:sink_data
	wire          y_min_pin_s1_agent_rp_ready;                                                // router_014:sink_ready -> y_min_pin_s1_agent:rp_ready
	wire          y_min_pin_s1_agent_rp_startofpacket;                                        // y_min_pin_s1_agent:rp_startofpacket -> router_014:sink_startofpacket
	wire          y_min_pin_s1_agent_rp_endofpacket;                                          // y_min_pin_s1_agent:rp_endofpacket -> router_014:sink_endofpacket
	...
	wire          y_max_pin_s1_agent_rp_valid;                                                // y_max_pin_s1_agent:rp_valid -> router_015:sink_valid
	wire  [109:0] y_max_pin_s1_agent_rp_data;                                                 // y_max_pin_s1_agent:rp_data -> router_015:sink_data
	wire          y_max_pin_s1_agent_rp_ready;                                                // router_015:sink_ready -> y_max_pin_s1_agent:rp_ready
	wire          y_max_pin_s1_agent_rp_startofpacket;                                        // y_max_pin_s1_agent:rp_startofpacket -> router_015:sink_startofpacket
	wire          y_max_pin_s1_agent_rp_endofpacket;                                          // y_max_pin_s1_agent:rp_endofpacket -> router_015:sink_endofpacket
	...
	wire          y_min_pin_s1_agent_rdata_fifo_src_valid;                                    // y_min_pin_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_012:in_0_valid
	wire   [33:0] y_min_pin_s1_agent_rdata_fifo_src_data;                                     // y_min_pin_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_012:in_0_data
	wire          y_min_pin_s1_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter_012:in_0_ready -> y_min_pin_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_012_out_0_valid;                                          // avalon_st_adapter_012:out_0_valid -> y_min_pin_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_012_out_0_data;                                           // avalon_st_adapter_012:out_0_data -> y_min_pin_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_012_out_0_ready;                                          // y_min_pin_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_012:out_0_ready
	wire    [0:0] avalon_st_adapter_012_out_0_error;                                          // avalon_st_adapter_012:out_0_error -> y_min_pin_s1_agent:rdata_fifo_sink_error
	wire          y_max_pin_s1_agent_rdata_fifo_src_valid;                                    // y_max_pin_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_013:in_0_valid
	wire   [33:0] y_max_pin_s1_agent_rdata_fifo_src_data;                                     // y_max_pin_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_013:in_0_data
	wire          y_max_pin_s1_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter_013:in_0_ready -> y_max_pin_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_013_out_0_valid;                                          // avalon_st_adapter_013:out_0_valid -> y_max_pin_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_013_out_0_data;                                           // avalon_st_adapter_013:out_0_data -> y_max_pin_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_013_out_0_ready;                                          // y_max_pin_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_013:out_0_ready
	wire    [0:0] avalon_st_adapter_013_out_0_error;                                          // avalon_st_adapter_013:out_0_error -> y_max_pin_s1_agent:rdata_fifo_sink_error
